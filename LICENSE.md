...
ここで公開したそれぞれは僕にとってはやや難しいくらいだが、需要があるなら、LLM提供者やプラットフォーマが全てをパッキングし、洗練したサービスをそのうち提供するだろう。それまでのつなぎだと思ってほしい。
...
コードは公開している。好きにフォークして持って行ってくれ。（どうせ一週間もかからず君は作るだろう。）
