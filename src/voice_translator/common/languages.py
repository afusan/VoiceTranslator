...
ISO1_TO_ISO3: dict[str, str] = {
    ...
    # Swahili: 639-1 "sw" は個別言語 swh(NLLB/MMS が使う FLORES/checkpoint コード)へ。
    "sw": "swh", "ta": "tam", "te": "tel", "tg": "tgk", "tk": "tuk", "tl": "tgl",
...
LANGUAGE_NAMES: dict[str, str] = {
    ...
    "yid": "Yiddish",
    "yor": "Yoruba",
    # === 低資源言語の拡張(MMS-TTS ∩ NLLB-200 で検証済み。多くは 639-1 を持たない)===
    # この集合は「翻訳でき、かつ MMS で読み上げできる」言語(出力言語候補として実用になる)。
    # コードはすべて MMS チェックポイント(facebook/mms-tts-<code>)/ NLLB FLORES の基底と一致。
    "ace": "Acehnese",
    "aka": "Akan",
    "awa": "Awadhi",
    "ayr": "Central Aymara",
